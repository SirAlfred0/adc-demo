...
import { ADC_OPTIONS, ADC_TABLE_BRIDGE, ADCCommonService, ADCDateSplitter, ADCIOptions, ADCITableColumn, ADCITableEvent, ADCITableEventSelectEvent, ADCITableRow, ADCStaticValues } from '@asadi/angular-date-components/core';
...
export class SchedulerCustomViewComponent {
  
  // extends AdcSchedulerBase implements OnInit, OnDestroy
